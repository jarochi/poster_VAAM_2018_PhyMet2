...
\begin{figure}
\includegraphics[width=0.8\columnwidth]{suplem2.eps}
\end{figure}
...
Values above bars represent mean error of algorithm, below show mean errors of the best predictors found in the nested cross-validation.
